...
---
= Multipath verification for Linux hosts
:icons: font
:imagesdir: ../media/
...
Complete the following steps for Linux hosts.

. To verify that DM-MP multipath is configured and functioning correctly on a Linux host, run the following commands:``multipath -ll``
+
----
