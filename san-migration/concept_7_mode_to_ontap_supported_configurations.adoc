...
If you are using the FLI 7-Mode to ONTAP transition workflow, you don't need to verify your source (7-Mode controller) in the IMT. It won't be listed but is supported expressly for this transition workflow. You do still need to verify all hosts are in a supported configuration.
