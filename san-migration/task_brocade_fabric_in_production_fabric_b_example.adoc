...
[.lead]
The following is an example of a Brocade fabric in production fabric B. See documentation for your specific host for commands to determine WWPNs and create zones.
