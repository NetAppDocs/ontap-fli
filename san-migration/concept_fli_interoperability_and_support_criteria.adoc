...
summary: "The FLI Interoperability Matrix (IMT) is  a distinctly different interoperability tool designed to better support the NetApp-qualified source arrays that work with FLI."
---
...
[.lead]
The FLI Interoperability Matrix (IMT) is  a distinctly different interoperability tool designed to better support the NetApp-qualified source arrays that work with FLI.
...
// 2025 Nov 18, Internal Git Issue 52