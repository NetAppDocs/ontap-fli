...
[NOTE]
The foreign array commands will differ depending on the third-party array from which you are migrating. See the documentation for your specific array for details on specific commands.
...
link:concept_creating_the_host_to_destination_zones.html[Creating the host to destination zones]

// 2026 Jan 14, ONTAPDOC 3086
