...
Any third-party software is removed. NetApp software is installed and configured. See link:reference_host_remediation.html[host remediation] for examples of post-migration remediation for specific host types.
