...
The following is an illustration of the host and destination storage zoning.  See documentation for your specific host for commands to determine host WWPNs and create zones. 
