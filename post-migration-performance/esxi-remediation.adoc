...
summary: "Remediate VMware ESXi datastores with ATS-only VMFS headers that can prevent mounting when presented through an online FLI import relationship."
---
= Perform ONTAP FLI ESXi VMFS ATS/CAW remediation
:icons: font
:imagesdir: ../media/
