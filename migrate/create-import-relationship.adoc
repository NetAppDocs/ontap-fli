...
----
+
After the LUN is brough online, discover the LUN on the host, and perform any subsequent host-specific remediations; then you can start the workloads on the LUN.
