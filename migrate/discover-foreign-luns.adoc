...
summary: "Deprovision the foreign LUN from the host and map it to the ONTAP initiator so that ONTAP can discover the LUN in its storage stack."
---
= Discover foreign LUNs for ONTAP FLI migration
:icons: font
:imagesdir: ../media/
