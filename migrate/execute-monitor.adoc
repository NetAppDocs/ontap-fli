...
summary: "Start the LUN import and monitor progress. Pause and resume the copy stream to manage bandwidth contention between the import and active host workloads."
---
= Execute and monitor the ONTAP FLI LUN import
:icons: font
:imagesdir: ../media/
