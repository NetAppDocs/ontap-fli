...
summary: "Run one or more test migrations to confirm that arrays, the network and fabric, ONTAP configuration, and host remediation steps are correct, and to collect throughput samples that can be extrapolated for production scheduling."
---
= Run a test migration for ONTAP FLI cutover planning
:icons: font
:imagesdir: ../media/
