...
C1_sti84-vsim-ucs207m_cluster iSCSI_FLI_IC_1 172.21.180.220 sti84-vsim-ucs207m e0d       sti84-vsim-ucs207m e0d       up          up           Default
C1_sti84-vsim-ucs207m_cluster iSCSI_FLI_IC_2 172.21.180.228 sti84-vsim-ucs207n e0d       sti84-vsim-ucs207n e0d       up          up           Default
...
------------------ ---- ---- ---- ----------- ---------- ------- ---------------- -------------
sti84-vsim-ucs207m e0d  up   1500 auto        1000       Default Default          healthy
sti84-vsim-ucs207n e0d  up   1500 auto        1000       Default Default          healthy
2 entries were displayed.
====
...
.Example output
====
C1_sti84-vsim-ucs207m_cluster::*>  network ping -node sti84-vsim-ucs207n -destination 172.21.180.238
172.21.180.238 is alive
C1_sti84-vsim-ucs207m_cluster::*> network ping -node sti84-vsim-ucs207m -destination 172.21.180.238
172.21.180.238 is alive
C1_sti84-vsim-ucs207m_cluster::*>
====
...
.Example output
====
C1_sti84-vsim-ucs207m_cluster::> set -privilege advanced
...
.Example output
====
C1_sti84-vsim-ucs207m_cluster::*> storage iscsi-initiator show
...
.Example
====
C1_sti84-vsim-ucs207m_cluster::*>  storage iscsi-initiator create -node sti84-vsim-ucs207m -initiator-name init207m  -lif iSCSI_FLI_IC_1
C1_sti84-vsim-ucs207m_cluster::*> storage iscsi-initiator create -node sti84-vsim-ucs207n -initiator-name init207n  -lif iSCSI_FLI_IC_2
====
...
------------  ---------  -----------  ---------------------  ----------------  -------------
sti84-vsim-ucs207m  init207m  iSCSI_FLI_IC_1  iqn.1992-08.com.netapp:sn.4086639599:vs.1  80:0a:75:00:00:00  online
sti84-vsim-ucs207n  init207n  iSCSI_FLI_IC_2  iqn.1992-08.com.netapp:sn.4086639600:vs.1  80:1f:61:00:00:00  online
2 entries were displayed.
====
...
.Example
====
C1_sti84-vsim-ucs207m_cluster::*> storage iswi initiator session create -node sti84-vsim-ucs207m -initiator-name init207m -target-name iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3 -target-ip 172.21.180.238
C1_sti84-vsim-ucs207m_cluster::*> storage iswi initiator session create -node sti84-vsim-ucs207n -initiator-name init207n -target-name iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3 -target-ip 172.21.180.238

C1_sti84-vsim-ucs207m_cluster::*> storage iswi initiator session create -node sti84-vsim-ucs207n -initiator-name init207n -target-name iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3 -target-ip 172.21.180.230
C1_sti84-vsim-ucs207m_cluster::*> storage iswi initiator session create -node sti84-vsim-ucs207m -initiator-name init207m -target-name iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3 -target-ip 172.21.180.230
====
+
...
C1_sti84-vsim-ucs207m_cluster::*> storage iswi initiator session show
 ...
 Node         Name       Name                         Port
------------  ---------  ------------   -------------   ------   ----------   -----  --------
sti84-vsim-ucs207m  init207m  iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3   172.21.180.230   3260   1026      2  online
sti84-vsim-ucs207m  init207m  iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3   172.21.180.238   3260   1032      1  online
sti84-vsim-ucs207n  init207n  iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3   172.21.180.230   3260   1026      1  online
sti84-vsim-ucs207n  init207n  iqn.1992-08.com.netapp:sn.054a3ea61f7c11f1bc73005056acc5b1:vs.3   172.21.180.238   3260   1032      2  online
