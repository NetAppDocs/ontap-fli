...
* Beginning with ONTAP 9.12.1, the maximum foreign LUN size for import is 125TB per LUN. See the Knowledge Base article link:https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/Unable_to_migrate_Array_lun_greater_than_16_TB_using_FLI[Unable to migrate Array LUN greater than 16 TB using FLI^] for more details.
