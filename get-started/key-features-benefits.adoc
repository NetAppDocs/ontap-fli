...
summary: "Learn about the key features and benefits of ONTAP FLI including online and offline migration options and block-level LUN migration for SAN environments."
---
= Key features and benefits of ONTAP Foreign LUN Import
:icons: font
:imagesdir: ../media/
